...
# You must replace "spawn-fcgi" and "SPAWN-FCGI" with the lower case name and
...
#
SPAWN-FCGI_SITE=http://download.lighttpd.net/spawn-fcgi/releases-1.6.x/
SPAWN-FCGI_VERSION=1.6.3
SPAWN-FCGI_SOURCE=spawn-fcgi-$(SPAWN-FCGI_VERSION).tar.gz
SPAWN-FCGI_DIR=spawn-fcgi-$(SPAWN-FCGI_VERSION)
SPAWN-FCGI_UNZIP=zcat
SPAWN-FCGI_MAINTAINER=NSLU2 Linux <nslu2-linux@yahoogroups.com>
SPAWN-FCGI_DESCRIPTION=a common gate interface daemon manage deamon
SPAWN-FCGI_SECTION=net
...
#
SPAWN-FCGI_PATCHES=$(SPAWN-FCGI_SOURCE_DIR)/spawn-fcgi.c.patch
...
#	if test -n "$(UPD-ALT_PREFIX)"; then \
	...
	$(WHAT_TO_DO_WITH_IPK_DIR) $(SPAWN-FCGI_IPK_DIR)
