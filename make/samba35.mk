...
SAMBA35_DEPENDS=avahi, popt, readline, zlib, e2fsprogs, cups
...
ifeq ($(OPTWARE_TARGET), $(filter f4nasmv6282, $(OPTWARE_TARGET)))
SAMBA35_PATCHES+=$(SAMBA35_SOURCE_DIR)/sendfile.c.patch
SAMBA35_PATCHES+=$(SAMBA35_SOURCE_DIR)/recvfile.c.patch
endif
